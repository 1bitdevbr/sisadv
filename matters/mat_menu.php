			<div class="container col-12">
				<div class="row callout callout-danger user-panel" style="justify-content: center; align-items: center; display: flex; vertical-align: middle;">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-8 offset-md-2" style="justify-content: center; align-items: center; text-align: center; display: table-cell; vertical-align: middle; margin: auto;">
                                                <form name="form_search" action="?pg=matters/mat_main" method="POST">
                    ...
                    <div class="col-sm" style="text-align: right;">
                        <!-- <a href="?pg=clients/main" class="btn btn-app" title="Voltar" style="text-decoration: none;"><i class="fas fa-backward"></i>Voltar</a> -->
                        <a href="?pg=matters/mat_main" class="btn btn-app" title="Listar Assuntos" style="text-decoration: none;"><i class="fa fa-search"></i>Listar</a>
                        <a href="?pg=matters/mat_register" class="btn btn-app" title="Cadastrar Assunto" style="text-decoration: none;"><i class="fas fa-plus"></i>Cadastrar</a>
                        <a href="?pg=matters/mat_main" class="btn btn-app" title="Menu" style="text-decoration: none;"><i class="fa fa-bars"></i>Menu</a>
