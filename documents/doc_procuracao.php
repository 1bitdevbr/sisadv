<?php
  ...
  // ======================================================================================= //
  if( ( $_SERVER[ "REQUEST_METHOD" ] == "POST" ) && ( isset( $_POST[ 'ACTION' ] ) ) && ( $_POST[ 'ACTION' ] == 'PROCURACAO' ) ) {
    $ID = $_POST[ 'ID' ];
    $ADV_ADVOGADOS = $_POST[ 'ADV_ADVOGADOS' ];
    $ADV_PODERES = $_POST[ 'ADV_PODERES' ];
        ...
        <div class="invoice p-3 mt-3 mb-3">
            ...
            <div class="PDF container-fluid background" style="width: 98%; margin-right: 2px;">
                ...
                <div class="cabecalho mt-2 mb-2" style="text-align: center;">
                    <span class="titulo">PROCURAÇÃO AD JUDICIA<br />ET EXTRA</span>
                </div>

                <!--// LAYOUT DO DOCUMENTO //-->
                <!--// 1. OUTORGANTE //-->
                <div class="row">
                    <span class="topico">1. OUTORGANTE</span>
                ...
                <!--// 2. OUTORGADO(S) //-->
                <div class="row">
                    <span class="topico">2. OUTORGADO(S)</span>
                    <div class="texto col-sm-12">
                ...
                <!--// 3. PODERES //-->
                <div class="row">
                    <span class="topico">3. PODERES OUTORGADOS</span>
                    <div class="texto col-sm-12">
                        <p><?= $ADV_PODERES; ?></p>
                    </div>
                </div><!-- /.row -->
