<?php
  ...
  // ======================================================================================= //
  if( ( $_SERVER[ "REQUEST_METHOD" ] == "POST" ) && ( isset( $_POST[ 'ACTION' ] ) ) && ( $_POST[ 'ACTION' ] == 'RECIBO' ) ) {
    $ID = $_POST[ 'ID' ];
    $ADV_ADVOGADOS = $_POST[ 'ADV_ADVOGADOS' ];
    $REC_ROL_DOCS = $_POST[ 'REC_ROL_DOCS' ];
    $REC_TERMO = $_POST[ 'REC_TERMO' ];

    // mysqli_query( $CONN, " UPDATE DOC_RECIBO SET REC_TERMO = '$REC_TERMO' " );
...
<div class="content-wrapper" style="background-color: rgb( 255, 255, 255 );"><!-- Content Header (Page header) -->
	...
	<!-- Main content -->
	<section class="content" style="max-width: 90%; background-color: rgb( 255, 255, 255 );">
      ...
      <div class="invoice p-3 mt-3 mb-3" style="background-color: rgb( 255, 255, 255 );">
        ...
        <div class="PDF container-fluid" style="background-color: rgb( 255, 255, 255 );" style="width: 98%; margin-right: 2px;">
          ...
          <div class="">
            ...
            <!--// 1. RELAÇÃO DE DOCUMENTOS RESTITUÍDOS //-->
            <legend style="font-size: 0.9em; letter-spacing: 0.1em; color: rgb( 0, 0, 0 ); font-weight: 500; text-align: left; text-transform: uppercase;"><b>&nbsp;1. RELAÇÃO DE DOCUMENTO(S) RESTITUÍDOS:</b></legend>
            <div class="row" style="justify-content: justify; align-items: justify; vertical-align: middle; text-align: justify;">
              <div class="col-sm-12">
                <p style="font-size: 0.8em; letter-spacing: 0.1em; background-color: rgb( 255, 255, 255 ); color: rgb( 0, 0, 0 );">
                  <?= $REC_ROL_DOCS; ?>
                </p>
              </div>
            </div>
            ...
            <!--// 2. ADVOGADO(S) //-->
            <legend style="font-size: 0.9em; letter-spacing: 0.1em; color: rgb( 0, 0, 0 ); font-weight: 500; text-align: left; text-transform: uppercase;"><b>&nbsp;2. ADVOGADO(S)</b></legend>
            <div class="row" style="justify-content: justify; align-items: justify; vertical-align: middle; text-align: justify;">
              <div class="col-sm-12">
                <p style="letter-spacing: 0.1em; background-color: rgb( 255, 255, 255 ); color: rgb( 0, 0, 0 );">
                  <?php
            ...
            <!--// 3. TERMO //-->
            <legend style="font-size: 0.9em; letter-spacing: 0.1em; color: rgb( 0, 0, 0 ); font-weight: 500; text-align: left; text-transform: uppercase;"><b>&nbsp;3. DECLARAÇÃO</b></legend>
            <div class="row" style="justify-content: justify; align-items: justify; vertical-align: middle; text-align: justify;">
              <div class="col-sm-12">
                <p style="font-size: 1.0em; letter-spacing: 0.1em; background-color: rgb( 255, 255, 255 ); color: rgb( 0, 0, 0 );">
                  ...
                  na cidade de <?= safe_ucwords($DADOS[ 'CLI_CIDADE' ]); ?>/<?= $DADOS[ 'CLI_UF' ]; ?>, <?= $REC_TERMO; ?>.
                </p>
              </div>
            </div><!-- /.row -->

            <!--// 4. DATA //-->
            <div style="font-size: 0.8em; letter-spacing: 0.1em; background-color: rgb( 255, 255, 255 ); color: rgb( 0, 0, 0 );">
              <span style="font-weight: light;"><?= safe_ucwords( strtolower( $CLIENT_CITY ) ); ?>, <?= date( 'd' ); ?> de <?= strtolower( mostraMes( date( 'm' ) ) ); ?> de <?= date( 'Y' ); ?>.</span>
              <br /><br /><br />
