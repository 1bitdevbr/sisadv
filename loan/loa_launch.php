	...
	<section class="content">
		<div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <form class="signin-form" formname="loan" id="loan" action="?pg=loan/loa_insert_payment" method="POST">
                    <div class="row">
                        <div class="form-group col-sm-2">
                    ...
                    <div class="container">
                        <div class="row justify-content-center align-items-center">
                            <h5 style="color: rgb( 205, 204, 204 ); font-weight: 500; letter-spacing: 0.1em; text-align: center; text-transform: uppercase;">Lançamento</h5>
                        </div>
                        <div class="row justify-content-center align-items-center" style="text-align: center;">
                            <div class="form-group col-sm-2">
                                <label>Data</label>
                                <input class="form-control" type="date" name="EPG_DT_PGTO" value="<?= date('Y-m-d'); ?>" autofocus required />
                            </div>
                            <div class="form-group col-sm-2">
                                <label>Valor</label>
                                R$&nbsp;<input class="form-control money" type="text" id="valor" name="EPG_VALOR" size="10" maxlength="9" data-precision="2" value="" onkeypress="$('.money').mask('000.000.000.000.000,00', {reverse: true});" required />
                            </div>
                        </div>
                    </div>
