            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center mb-5  animated pulse myForm">
                        ...
                        <h3 style="color: aliceblue;">SISTEMA EM MANUTENÇÃO</h3><br /><br /><br />
                        <h5 style="color: antiquewhite;">
                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~<br />
                            Olá, <?= $NAME; ?>!<br /><br /><br />
                            No momento, o sistema se encontra temporariamente indisponível, por favor, retorne dentro de alguns minutos.
                            <br />~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                        </h5>
                    </div>
                </div>
                    ...
                    <div class="login-wrap p-0">
                        ...
                        <div class="lockscreen-wrapper">
                            ...
                            <div class="text-center">
                                <a href="/../login/login.php" style="color: rgb( 248, 235, 214 );" onmouseover="this.style.color='rgb( 253, 224, 139 )'" onmouseout="this.style.color='rgb( 248, 235, 214 )'">Atualizar <i class="fa-solid fa-arrows-rotate"></i></a>
                            </div>
