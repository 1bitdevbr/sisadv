                ...
                <form class="signin-form" formname="inventory" id="inventory" action="?pg=inventory/inv_update" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-2">
                            ...
                            <input class="form-control money" type="text" id="INV_VR_ESTIMADO" name="INV_VR_ESTIMADO" value="<?= formata_dinheiro( $DADOS[ 'INV_VR_ESTIMADO' ] ); ?>" onkeypress="$('.money').mask('000.000.000.000.000,00', {reverse: true});" />
                        </div>
                    </div>
                    <div class="row">
