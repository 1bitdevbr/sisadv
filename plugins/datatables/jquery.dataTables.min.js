...
fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": classificar em ordem crescente",sSortDescending:": classificar em ordem decrescente"},oPaginate:{sFirst:"First",sLast:"Last",
sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Sem dados disponíveis na tabela",sInfo:"Exibindo _START_ / _END_ de _TOTAL_ registros",sInfoEmpty:"Sem registro para exibir",sInfoFiltered:"(filtrado do total de _MAX_ registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ registros",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Pesquisa:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum resultado encontrado"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
