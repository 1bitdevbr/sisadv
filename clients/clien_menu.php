            <div class="container col-12">
				<div class="row callout callout-danger user-panel" style="justify-content: center; align-items: center; display: flex; vertical-align: middle;">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-8 offset-md-2" style="justify-content: center; align-items: center; text-align: center; display: table-cell; vertical-align: middle; margin: auto;">
                                                <form name="form_search" action="?pg=clients/clien_search" method="POST">
                    ...
                    <div class="col-sm" style="text-align: right;">
                        <?php if( strpos( $_SERVER[ 'REQUEST_URI' ], 'clien_view' ) ) { ?><a href="?pg=clients/clien_editar&id=<?= $DADOS[ 'CLI_ID' ]; ?>" class="btn btn-app" title="Editar Cliente" style="text-decoration: none;"><i class="fas fa-edit"></i>Editar</a><?php } ?>
                        ...
                        <a href="?pg=clients/clien_cadastro" class="btn btn-app" title="Cadastrar Cliente" style="text-decoration: none;"><i class="fas fa-plus"></i>Cadastrar</a>
                        <a href="../index.php?pg=clients/main" class="btn btn-app" title="Menu" style="text-decoration: none;"><i class="fa fa-bars"></i>Menu</a>
