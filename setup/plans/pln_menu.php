			<div class="container col-12">
				<div class="row callout callout-danger user-panel" style="justify-content: center; align-items: center; display: flex; vertical-align: middle;">
                    ...
                    <div class="col-sm" style="text-align: right;">
                        <a href="?pg=setup/plans/pln_register" class="btn btn-app" title="Cadastrar" style="text-decoration: none;"><i class="fas fa-plus"></i>Plano</a>
                        <a href="?pg=setup/plans/pln_main" class="btn btn-app" title="Menu" style="text-decoration: none;"><i class="fa fa-bars"></i>Menu</a>
