	...
	<section class="content">
      ...
      <div class="invoice p-3 mb-3 card card-danger card-outline"><!-- Invoice -->
        ...
        <div class="container-fluid">
          ...
          <form action="?pg=setup/plans/pln_update" method="POST">

            <center><legend style="justify-content: center; align-items: center; display: table; vertical-align: middle; font-size: 1.3rem; font-weight: 600; letter-spacing: 0.1em; text-align: center; text-transform: uppercase; color: rgb( 255, 255, 255 );">Edição de Plano</legend></center>
            ...
            <div class="form-row">
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" id="PLN_ID" name="PLN_ID" value="<?= $DADOS[ 'PLN_ID' ]; ?>" readonly />
              </div>
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" id="PLN_NAME" name="PLN_NAME" value="<?= $DADOS[ 'PLN_NAME' ]; ?>" onkeyup="this.value = this.value.toUpperCase();" />
              </div>
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="PLN_DESCRIPTION" name="PLN_DESCRIPTION" value="<?= $DADOS[ 'PLN_DESCRIPTION' ]; ?>" onkeyup="this.value = this.value.toUpperCase();" />
              </div>
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control money" id="PLN_PRICE" name="PLN_PRICE" value="<?= formata_dinheiro( $DADOS[ 'PLN_PRICE' ] ); ?>" onkeypress="$('.money').mask('000.000.000.000.000,00', {reverse: true});" />
              </div>
            </div>
