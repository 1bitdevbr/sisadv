	...
	<section class="content">
      ...
      <div class="invoice p-3 mb-3 card card-danger card-outline"><!-- Invoice -->
        ...
        <div class="container-fluid">
          ...
          <form action="?pg=setup/perfil/upf_edit" method="POST">

            <center><legend style="justify-content: center; align-items: center; display: table; vertical-align: middle; font-size: 1.3rem; font-weight: 600; letter-spacing: 0.1em; text-align: center; text-transform: uppercase; color: rgb( 255, 255, 255 );">Editar Perfil</legend></center>
            ...
            <div class="form-group" align="center">
              <a href="?pg=setup/perfil/upf_edit&id=<?= $DADOS[ 'USR_ID' ]; ?>" class="btn btn-outline-primary"><i class="fas fa-edit"></i>&nbsp;Editar</a>
            </div>
