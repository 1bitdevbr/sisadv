	...
	<section class="content">
      ...
      <div class="invoice p-3 mb-3 card card-danger card-outline"><!-- Invoice -->
        ...
        <div class="container-fluid">
          ...
          <form action="?pg=setup/users/usr_insert" method="POST">

            <center><legend style="justify-content: center; align-items: center; display: table; vertical-align: middle; font-size: 1.3rem; font-weight: 600; letter-spacing: 0.1em; text-align: center; text-transform: uppercase; color: rgb( 255, 255, 255 );">Cadastro de Usuário</legend></center>
            <div class="row justify-content-md-center">
              <div class="col col-md-1" align="right">
                <span><img src="<?= $IMG = '/dist/img/user.png'; ?>" width="80px" heigth="120px" style="border: 2px solid white; box-shadow: 5px 5px 5px 1px rgb( 108, 117, 125 );" /></span>
              </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" id="USR_ID" name="USR_ID" readonly />
              </div>
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="USR_NAME" name="USR_NAME" onkeyup="this.value = this.value.toUpperCase();" />
              </div>
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" id="USR_LOGIN" name="USR_LOGIN" onkeyup="this.value = this.value.toLowerCase();" />
              </div>
              <div class="form-group col-md-2">
              ...
              <div class="form-group col-md-6">
                ...
                <select class="form-control" name="USR_FK_DB_NAME" id="USR_FK_DB_NAME">
                  <?php
                    ...
                    while( $ROW = mysqli_fetch_array( $SQL ) ) { ?>
                    <option value="<?= $ROW[ 'DBA_ID' ]; ?>"><?= $ROW[ 'DBA_NAME' ]; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
